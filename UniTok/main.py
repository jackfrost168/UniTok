...
from models.rqvae_no_cf import RQVAE_no_cf
...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=10000, help='number of epochs') # 20000
    ...
    parser.add_argument('--num_emb_list', type=int, nargs='+', default=[256, 256, 256, 256], help='emb num of every vq') # [256, 256, 256, 256]
